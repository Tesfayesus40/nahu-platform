...
@Controller('delivery/buyer')
@UseGuards(ThrottlerGuard, JwtAuthGuard, RolesGuard)
@Roles('BUYER')
export class BuyerDeliveryController {
  ...
  list(
    ...
    return this.party.listShipments(user.userId, 'BUYER', {
      page: query.page,
      limit: query.limit,
      history:
  ...
  detail(
    ...
    return this.party.getShipmentDetail(user.userId, 'BUYER', id);
  }
  ...
  tracking(
    ...
    return this.party.getTrackingForOrder(user.userId, 'BUYER', orderId);
  }
}
