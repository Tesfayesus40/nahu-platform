...
| [Farmer Amharic confirmation](08-guides/farmer-amharic-full-confirmation.md) | **Completed** — Farmer UI EN/AM review applied (`milestone-amharic-localization-v1`) |
...
| 4 | Farmer Platform (Nahu Farm) — farms, inventory, warehouse, planning, dashboards, harvest, activities | **4.1–4.8 closed on staging**; Farmer Amharic localization **completed** (`milestone-amharic-localization-v1`); production Nest cutover held |
